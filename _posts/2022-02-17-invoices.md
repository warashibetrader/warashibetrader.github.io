...
This requires slightly more sophisticated javascript. While we're at it, we may as well start from scratch to slightly improve the cosmetics of the transaction. Include the following function in the global scope of your javascript:
...
The following example creates a thank you alert when payment is confirmed:
