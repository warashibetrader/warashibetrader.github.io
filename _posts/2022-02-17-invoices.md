...
### URL: Invoice static products and services
...
The makePaymentURL function returns the URL for an invoice filled using the three input parameters. Use this URL for your payment link/button. For instance, using the same HTML code for the button above,
