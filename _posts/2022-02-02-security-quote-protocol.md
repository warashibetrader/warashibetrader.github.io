...
The problem with using web apps for secure applications is that every time you visit the app, its code is newly downloaded and may be different from the trusted version you used last. The fact that the present app doesn't disappear with your private information in hand is not a guarantee - just a pleasant surprise.
